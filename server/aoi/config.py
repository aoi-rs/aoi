...
from aoi.enums import EmailSender
...
env = Environment(os.getenv("AOI_ENV", Environment.development))
...
class Settings(BaseSettings):
    ...
    # Database
    POSTGRES_USER: str = "aoi"
    POSTGRES_PWD: str = "aoi"
    POSTGRES_HOST: str = "127.0.0.1"
    POSTGRES_PORT: int = 5432
    POSTGRES_DATABASE: str = "aoi"
    ...
    EMAIL_FROM_NAME: str = "Aoi"
    EMAIL_FROM_DOMAIN: str = "notifications.aoi.rs"
    EMAIL_FROM_LOCAL: str = "mail"
    EMAIL_DEFAULT_REPLY_TO_NAME: str = "Aoi Support"
    EMAIL_DEFAULT_REPLY_TO_EMAIL_ADDRESS: str = "support@aoi.rs"
    ...
    # Sessions
    ACCESS_TOKEN_COOKIE_KEY: str = "aoi_access_token"
    REFRESH_TOKEN_COOKIE_KEY: str = "aoi_refresh_token"
