...
from aoi.kit.refresh_tokens import RefreshToken
from aoi.email.sender import email_sender
from aoi.auth.service import auth
from aoi.login_tokens.repository import LoginTokenRepository

logger = structlog.get_logger()


class LoginTokenInvalidOrExpired(AoiError):
    def __init__(self):
