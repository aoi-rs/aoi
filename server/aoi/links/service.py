...
from aoi.links.repository import link_repository
from aoi.auth.models import AuthContext
from aoi.links.counter import monotonic_counter
from aoi.links.utils import generate_slug, extract_uuid_timestamp
from aoi.exceptions import ResourceMissing
from aoi.kit.pagination import PaginationParams
from aoi.kit.utils import generate_uuid
...
class LinkService:
    ...
    def list(
        ...
        return link_repository.paginate(context, pagination)
