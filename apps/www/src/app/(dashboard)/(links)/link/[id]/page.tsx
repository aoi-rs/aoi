  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex flex-col flex-1 w-[calc(100%-2.5rem)] mx-auto">
        ...
        <div className="px-2.5 h-11 border border-aoi-700 flex items-center gap-2 rounded-lg bg-aoi-800">
          ...
          <div className="flex-1 flex overflow-hidden gap-2">
            ...
            <div className="flex overflow-hidden">
              <span className="whitespace-nowrap text-ellipsis leading-6 font-[450] text-sm text-aoi-500 overflow-hidden">
          ...
          <div className="shrink-0 flex items-center">
            <Button
              size="icon"
              variant="ghost"
              className="text-aoi-500 hover:text-white"
            >
              <Ellipsis />
            </Button>
          </div>
        ...
        <ul className="pb-18 pt-4 pr-2.5 flex flex-col">
          <li className="pb-2 flex items-center">
            <LayersPlus className="size-3.5 text-aoi-500 mx-3" />

            <span className="text-xs text-aoi-500 font-[450]">
