...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn(
        'pointer-events-none -mx-1 my-1 h-px bg-aoi-700',
        className,
      )}
      {...props}
    />
